...
const fixtureMcpInventories: Record<AgentKind, McpInventory> = {
    ...
    servers: [
      {
        ...
        scope: "user",
        scopeLabel: "",
        sourceId: "fixture-claude-source",
        sourcePath: "/Users/demo/.claude.json",
        transport: "stdio",
        endpoint: "npx",
        endpointKind: "value",
        state: "configured",
  ...
  hermes: {
    ...
    agent: "hermes",
    sources: [{
      id: "fixture-hermes-source",
      path: "/Users/demo/.hermes/config.yaml",
      label: "config.yaml",
      state: "loaded",
      diagnostic: null,
      serverCount: 1,
    ...
    servers: [
      {
        ...
        scope: "user",
        scopeLabel: "",
        sourceId: "fixture-hermes-source",
        sourcePath: "/Users/demo/.hermes/config.yaml",
        transport: "stdio",
        endpoint: "uvx",
        endpointKind: "value",
        state: "configured",
