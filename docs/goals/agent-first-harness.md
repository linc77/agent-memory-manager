...
- `docs/verification/2026-06-08-live-mvp-check.md` records current live MVP evidence.
- `docs/issues/2026-06-08-search-body-coverage.md` records the known search coverage gap.
...
7. Record new evidence in `docs/verification/`.
8. Update or close the related file in `docs/issues/`.
...
```text
/goal Turn this repository into an agent-first harness by following docs/goals/agent-first-harness.md. Continue until the near-term success criteria pass or a human judgment decision is required.
```
